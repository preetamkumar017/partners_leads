...
class QuickCalculationView extends StatefulWidget {
  const QuickCalculationView({Key? key}) : super(key: key);

  @override
  _QuickCalculationViewState createState() => _QuickCalculationViewState();
}

class _QuickCalculationViewState extends State<QuickCalculationView>  with TickerProviderStateMixin {
